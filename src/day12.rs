...
/*
  ...
  The ships navigation computer is malfunctioning.

  Part 1
  Navigation instructions (puzzle input) consists of actions and values
  - N/S/E/W meanst to move in the cardinal direction the given value
  - L/R mean to turn in the left/right direction by the given number of degrees
  - F means to move the ship forward by the given value
  The ship starts facing east
  The ships Manhattan distance is the sum of the N/S direction + the E/W direction.
  After executing the instructions, what is the ships Manhattan distance from the starting point?

  Part 2
  Navigation instructions actually mostly revolve around setting a waypoint:
  - N/S/E/W moves the waypoint north/south/east/west by the given value
  - L/R rotate the waypoint around the ship left(counter-clockwise)/right(clockwise) by the given number of degrees
  ...
  Examples:
    F10 moves the ship to the waypoint 10 times, leaving the ship at east 100, north 10. The waypoint stays 10 units east and 1 unit north of the ship.
    N3 moves the waypoint 3 units north to 10 units east and 4 units north of the ship. The ship remains at east 100, north 10.
    F7 moves the ship to the waypoint 7 times, leaving the ship at east 170, north 38. The waypoint stays 10 units east and 4 units north of the ship.
